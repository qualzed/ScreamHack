...
// RESET
#define RESET_COLOR     termcolor::reset
// OTHER
#define COLORIZE    termcolor::colorize
// BRIGHTS
#define br_red     termcolor::bright_red
#define br_green   termcolor::bright_green
#define br_blue    termcolor::bright_blue
#define br_yellow    termcolor::bright_yellow
#define br_cyan    termcolor::bright_cyan
#define br_grey    termcolor::bright_grey
#define br_magenta    termcolor::bright_magenta